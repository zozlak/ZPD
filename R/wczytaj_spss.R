...
#' @description
#' Funkcja:
#' - wczytuje plik SPSS z to.data.frame=T, use.missings=F, trim.factor.names=T
#' - zamienia nazwy wszystkich zmiennych na pisane malymi literami
#' - zamienia wszystkie factor-y na zwykle zmienne typu character
#' - wykonuje str_trim() na wszystkich zmiennych
#' @details
#' _
