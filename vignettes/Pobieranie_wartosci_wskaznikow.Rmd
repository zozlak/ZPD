...
* http://zpd.ibe.edu.pl/doku.php?id=r_gr#podsumowanie_informacji_o_grupach_danych
* http://zpd.ibe.edu.pl/doku.php?id=r_zmienne
...
W tym celu przydatne będą funkcje `filter()`, `select()` i `arrange()` omawiane na wcześniejszym warsztacie.  
...
ggplot(pwe_spr_woj, aes(x = rok, y = srednia, color = wojewodztwo_jst, fill = wojewodztwo_jst)) +
  ...
  scale_y_continuous(limits=c(94, 104)) +
...
Podobne dane możemy pobrać dla EWD.
